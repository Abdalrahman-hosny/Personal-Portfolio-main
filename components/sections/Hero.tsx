      ...
      <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 w-full max-w-6xl">
        ...
        <div className="order-2 lg:order-1 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
            ...
            <a
              href="/Abdalrahman Hosny - Frontend Developer.pdf"
              download
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 bg-[#FEF418] z-0"></div>
                <Image
                  src="/landing.png"
                  alt={personalInfo.name}
                  fill
                  className="object-cover scale-110 translate-y-2 group-hover:scale-115 transition-transform duration-700 relative z-10"
                  priority
